...
colnames(dpheno2) <- c("ID", "Spec.Nacc")
   newID <- substring(dpheno2$ID,2) #Removes leading M from ID column
   dpheno2[,1] <- newID
...
summary(lm(Spec.Nacc~SNP201501, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP203254, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP209958, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP210858, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP211385, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP211980, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP212087, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP212570, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP213026, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP213106, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP213739, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP225814, dd))$coefficients[8]
summary(lm(Spec.Nacc~SNP234447, dd))$coefficients[8]
...
#Phelps plots
par(mfrow=c(3, 5))
lapply(34:47, function(x) plot(as.factor(dd[,x]),dd$Spec.Nacc, xlab=names(dd[x]), main=round(summary(lm(dd$Spec.Nacc~dd[,x]))$r.squared, 4)))
...
#Ophir plots
par(mfrow=c(3, 5))
lapply(32:45, function(x) plot(as.factor(dd[,x]),dd$Spec.Nacc, xlab=names(dd[x]), main=round(summary(lm(dd$Spec.Nacc~dd[,x]))$r.squared, 4)))

#_________________________________________________________________
#Create Z scores
dpheno$Z <- scale(dpheno$Spec.Nacc, center = TRUE, scale = TRUE)
dpheno2$Z <- scale(dpheno2$Spec.Nacc, center = TRUE, scale = TRUE)

#Rbind
z_pheno <- rbind(dpheno[,c(1,4)], dpheno2[,c(1,3)])

#Merge with Geno
dd <- merge(z_pheno, dgeno, by="ID")
...
summary(lm(Z~SNP201501, dd))$r.squared
summary(lm(Z~SNP203254, dd))$r.squared
summary(lm(Z~SNP209958, dd))$r.squared
summary(lm(Z~SNP210858, dd))$r.squared
summary(lm(Z~SNP211385, dd))$r.squared
summary(lm(Z~SNP211980, dd))$r.squared
summary(lm(Z~SNP212087, dd))$r.squared
summary(lm(Z~SNP212570, dd))$r.squared
summary(lm(Z~SNP213026, dd))$r.squared
summary(lm(Z~SNP213106, dd))$r.squared
summary(lm(Z~SNP213739, dd))$r.squared
summary(lm(Z~SNP225814, dd))$r.squared
summary(lm(Z~SNP234447, dd))$r.squared

summary(lm(Z~SNP201501, dd))$coefficients[8] 
summary(lm(Z~SNP203254, dd))$coefficients[8]
summary(lm(Z~SNP209958, dd))$coefficients[8]
summary(lm(Z~SNP210858, dd))$coefficients[8]
summary(lm(Z~SNP211385, dd))$coefficients[8]
summary(lm(Z~SNP211980, dd))$coefficients[8]
summary(lm(Z~SNP212087, dd))$coefficients[8]
summary(lm(Z~SNP212570, dd))$coefficients[8]
summary(lm(Z~SNP213026, dd))$coefficients[8]
summary(lm(Z~SNP213106, dd))$coefficients[8]
summary(lm(Z~SNP213739, dd))$coefficients[8]
summary(lm(Z~SNP225814, dd))$coefficients[8]
summary(lm(Z~SNP234447, dd))$coefficients[8]


#Z score plots
par(mfrow=c(3, 5))
lapply(32:45, function(x) plot(as.factor(dd[,x]),dd$Z, xlab=names(dd[x]), main=round(summary(lm(dd$Z~dd[,x]))$r.squared, 4)))
